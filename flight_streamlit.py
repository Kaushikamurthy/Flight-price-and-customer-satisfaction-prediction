...
def load_data():
    try:
        ...
        price_df = pd.read_csv(r"C:\Users\user\Desktop\guvi\flight\data\code\price_pred.csv")
        satisfaction_df = pd.read_csv(r"C:\Users\user\Desktop\guvi\flight\data\code\satisfication_pred.csv")
